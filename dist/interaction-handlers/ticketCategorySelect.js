...
exports.TicketCategorySelectHandler = void 0;
const framework_1 = require("@sapphire/framework");
const discord_js_1 = require("discord.js");
const prisma_1 = require("../lib/prisma");
class TicketCategorySelectHandler extends framework_1.InteractionHandler {
    ...
    async run(interaction) {
        ...
        try {
            ...
            if (!category) {
                const msg = await interaction.followUp({ content: 'Category not found.', flags: [discord_js_1.MessageFlags.Ephemeral] });
            ...
            const errorMsg = await interaction.followUp({ content: 'Failed to create ticket. Please check my permissions.', flags: [discord_js_1.MessageFlags.Ephemeral] });
            setTimeout(() => interaction.webhook.deleteMessage(errorMsg.id).catch(() => { }), 5000);
            return;
        }
    }
}
exports.TicketCategorySelectHandler = TicketCategorySelectHandler;
//# sourceMappingURL=ticketCategorySelect.js.map